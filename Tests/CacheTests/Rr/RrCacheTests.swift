...
final class RrCacheTests: XCTestCase {
    ...
    func testRepeatingKeyAccess() throws {
        try testCacheHitRatio(
            scenarios: [
                (capacity: 100, keys: 50, hitRate: 1.0, line: #line),
                (capacity: 100, keys: 125, hitRate: 1.0, line: #line),
                (capacity: 100, keys: 150, hitRate: 1.0, line: #line),
                (capacity: 100, keys: 200, hitRate: 1.0, line: #line),
            ],
    ...
    func testRepeatingRangeAccess() throws {
        try testCacheHitRatio(
            scenarios: [
                ...
                (capacity: 100, keys: 125, hitRate: 0.62, line: #line),
                (capacity: 100, keys: 150, hitRate: 0.41, line: #line),
                (capacity: 100, keys: 200, hitRate: 0.20, line: #line),
            ],
            accesses: { capacity, keys in
                10 * capacity
            },
    ...
    func testUniformRandomAccess() throws {
        try testCacheHitRatio(
            scenarios: [
                (capacity: 100, keys:  50, hitRate: 1.00, line: #line),
                (capacity: 100, keys: 125, hitRate: 0.80, line: #line),
                (capacity: 100, keys: 150, hitRate: 0.66, line: #line),
                (capacity: 100, keys: 200, hitRate: 0.50, line: #line),
            ],
            accesses: { capacity, keys in
                10 * capacity
            },
    ...
    func testZipfianRandomAccess() throws {
        try testCacheHitRatio(
            scenarios: [
                (capacity: 100, keys:  50, hitRate: 1.00, line: #line),
                (capacity: 100, keys: 125, hitRate: 0.92, line: #line),
                (capacity: 100, keys: 150, hitRate: 0.87, line: #line),
                (capacity: 100, keys: 200, hitRate: 0.79, line: #line),
            ],
            accesses: { capacity, keys in
                10 * capacity
            },
